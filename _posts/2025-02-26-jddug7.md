...
#6に続き、今回もリアルとリモートのハイブリット開催でした。録画は以下の YouTube でご覧いただけます。

＜まだ６回目分＞ーーーーーーーーーーーーーーーーーーーーーーーーーーー
...
<p>LT4. <a href="#video" onclick="setVideoTime(2883)">sugar-cat / xxxxx</a></p>
...
前回に続き、今回もかのさんが sli.do の機能で Datadog クイズを実施しました。早押しクイズで皆楽しみながら真剣に参加していました！
