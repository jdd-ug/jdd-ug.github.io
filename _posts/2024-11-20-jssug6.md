...
<p>発表1. <a href="#" onclick="setVideoTime(0)">横山達男 (tatsuo48) / 株式会社マネーフォワード</a></p>
<p>発表2. <a href="#" onclick="setVideoTime(504)">今村 光希（@imamura_ko_0314） / 株式会社Goals</a></p>
<p>発表3. <a href="#" onclick="setVideoTime(1058)">笹崎 日登 / アイレット株式会社</a></p>
<p>発表4. <a href="#" onclick="setVideoTime(1754)">宮本 淳志 (@Atsushi68593216) / 株式会社ログラス</a></p>
<p>LT1. <a href="#" onclick="setVideoTime(2248)">福井崇人 / Retty株式会社</a></p>
<p>LT2. <a href="#" onclick="setVideoTime(2525)">竹屋 正樹 / キンドリルジャパン株式会社</a></p>
<p>LT3. <a href="#" onclick="setVideoTime(2883)">門脇 拓巳 (@nomadblacky) / 株式会社スリーシェイク</a></p>
<script>
    function setVideoTime(seconds) {
        var iframe = document.getElementById('youtube-iframe'); 
        iframe.src = "https://www.youtube.com/embed/WiCaKobpaUk?start=" + seconds;
    }
</script>
